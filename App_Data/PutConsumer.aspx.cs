...
public partial class PutConsumer : System.Web.UI.Page
{
    ...
    protected void ddlUC_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //ddlBlock.DataSource = downs.SelectedBlock(Convert.ToInt16(ddlUC.SelectedValue));
    ...
    protected void ddlpropertyType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //{
        //    lblsqyard.Text = "Squre Feet";
        //}
        //else
        //{
        //    lblsqyard.Text = "Squre Yard";
        //}
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        //cmd.Parameters.Add("@billing_month", SqlDbType.VarChar).Value = "Jan-Mar,2017";
        ...
        //cmd.Parameters.Add("@billing_period_code", SqlDbType.VarChar).Value = "01 2017 06-7";
    ...
    protected void btnCode_Click(object sender, EventArgs e)
    {
        ...
        //    txtConsumerID.Text = lblcode.Text + adDigit + "000";
