...
public partial class SpeacialConsumer : System.Web.UI.Page
{
    ...
    public void Calc()
    {
        ...
        else if (ddlpropertyType.SelectedItem.Text == "Commercial" || ddlpropertyType.SelectedItem.Text == "Office")
        {
        ...
        arears = amount + Convert.ToDouble(txtAdjustArrears.Text);
        lbladjust.Text = txtAdjustArrears.Text;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.Add("@billing_month", SqlDbType.VarChar).Value = "Jul-Dec, 2019";
        cmd.Parameters.Add("@current_Charges", SqlDbType.Decimal).Value = Convert.ToDouble(lblCurrentAmount.Text)*2;
        ...
        cmd.Parameters.Add("@billing_period_code", SqlDbType.VarChar).Value = "10 2019 01-5";
