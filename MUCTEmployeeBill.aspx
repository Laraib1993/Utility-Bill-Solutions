<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="MUCTEmployeeBill.aspx.cs" Inherits="MUCTEmployeeBill" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
     <title>MUCT Employee Billing History</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>MUCT Employee Billing History</h3>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Search <small>MUCT Employee Billing History</small></h2>
...
<Columns>
    ...
    <asp:BoundField 
     ...
     <asp:BoundField 
            DataField="Employee"
            HeaderText="MUCT EMployee" HeaderStyle-Wrap="False">
            <HeaderStyle HorizontalAlign="Center"></HeaderStyle> 
            <ItemStyle HorizontalAlign="Center" ForeColor="Black" BackColor="white" Font-Bold="True" ></ItemStyle>
        </asp:BoundField>
