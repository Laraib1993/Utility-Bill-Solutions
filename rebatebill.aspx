<%@ Page Title="" Language="VB" MasterPageFile="~/User.master" AutoEventWireup="false" CodeFile="rebatebill.aspx.vb" Inherits="rebatebill" %>
                    ...
                    <tr>
                     ...
                     <tr>
                         <td>
								...
								<asp:Button ID="btnPrint" OnClick = "btnins_Click" runat="server" Style="height: 25px;" OnClientClick ="Print()"  Text="Print" />
