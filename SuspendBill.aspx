<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="SuspendBill.aspx.cs" Inherits="SuspendBill" %>
                    ...
                    <form class="form-horizontal form-label-left" runat="server">
                      ...
                      <div class="ln_solid"></div>
                        ...
                        <asp:Panel ID="pnl" runat="server" Visible="false" >
                               ...
                               <div class="form-group">
                       <asp:Label ID="Label2" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Inword No" Font-Bold="True"></asp:Label>
                        <div class="col-md-6 col-sm-9 col-xs-12">
                              <asp:TextBox ID="txtinword" runat="server" type="text" class="form-control" placeholder="Inword No"></asp:TextBox>
                                 ...
                                 <div class="form-group">
                       <asp:Label ID="Label3" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Select Department" Font-Bold="True"></asp:Label>
                        <div class="col-md-6 col-sm-9 col-xs-12">
                             <asp:DropDownList class="form-control" ID="ddldept" runat="server">
                                  <asp:ListItem Value="0" Text="Select Department"></asp:ListItem>
                                 <asp:ListItem Value="Katchi Abadi" Text="Katchi Abadi"></asp:ListItem>
                                  <asp:ListItem Value="Land Department" Text="Land Department"></asp:ListItem>
                                  <asp:ListItem Value="PD Orangi" Text="PD Orangi"></asp:ListItem>
                                  <asp:ListItem Value="Estate Department" Text="Estate Department"></asp:ListItem>
                             </asp:DropDownList>
                               ...
                               <div class="form-group">
                       <asp:Label ID="Label1" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Select Zone" Font-Bold="True"></asp:Label>
                        <div class="col-md-6 col-sm-9 col-xs-12">
                             <asp:DropDownList class="form-control" ID="ddldistrict" runat="server" OnSelectedIndexChanged="ddldistrict_SelectedIndexChanged" AutoPostBack="true" ></asp:DropDownList>

                        </div>
                      </div>

                          <div class="form-group">
                        <asp:Label ID="lbldistrict" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Select Twon" Font-Bold="True"></asp:Label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                             <asp:DropDownList class="form-control" ID="ddltown" runat="server" ></asp:DropDownList>
