<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="Dept15.aspx.cs" Inherits="rebate" %>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="fs15 fw700 text-right">
                                 ...
                                 <tr>
                                <td>Part Payment Percentage</td>
                                <td class="fs15 fw700 text-right">
                                    <asp:Label ID="lblpercent" runat="server" Text=""></asp:Label>
                                </td>
                              </tr>
                                  <tr>
                                <td>Part Payment Amount</td>
                                <td class="fs15 fw700 text-right">
                                    <asp:Label ID="lblrefected" runat="server" Text=""></asp:Label>
                                </td>
                              </tr>
                                 <tr>
                                <td>Total Amount <br /> (Current Amount + Part Payment Amount)</td>
                                <td class="fs15 fw700 text-right">
