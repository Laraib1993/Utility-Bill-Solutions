<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="AddConsumerHistory.aspx.cs" Inherits="impact_search" %>




<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   <title>Add Consumer History Search</title>
</asp:Content>
     ...
     <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Add Consumer History Search</h3>
              </div>
