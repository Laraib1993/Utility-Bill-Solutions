                    ...
                    <form class="form-horizontal form-label-left" runat="server" novalidate>
                      ...
                      <div class="form-group">
                       <asp:Label ID="lblMobile" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Mobile" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <asp:TextBox ID="txtMobile" runat="server" type="number" class="form-control"  data-validate-linked="email" required="required" placeholder="Mobile Number"></asp:TextBox>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <asp:Label ID="lblConsunerID" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Consumer Number" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         ...
                         <asp:TextBox ID="txtConsumerID" runat="server" type="text" class="form-control"  style="text-transform:uppercase;" MaxLength="11" required="required" placeholder="Consumer No." OnTextChanged="txtConsumerID_TextChanged"></asp:TextBox>
                        </div>
                      </div>
                      ...
                      <div class="dashboard-widget-content">
                        <div class="col-md-12 hidden-small">
                          ...
                          <table class="countries_list">
                            <tbody>
                                <tr>
                                <td>Add new consumer as Residential as per survey Update as Approved by Senior Director and Director (MUCT) bearing Inword # XXXXX Dated XX-XX-XXXX as per KMC pick-Up Form Attached
</td>
                                <td class="fs15 fw700 text-right">
                                ...
                                <tr>
                                     <td>Add new consumer as Flat as per survey Update as Approved by Senior Director and Director (MUCT) bearing Inword # XXXXX Dated XX-XX-XXXX as per KMC pick-Up Form Attached
</td>
                                <td class="fs15 fw700 text-right">
                                 ...
                                 <tr>
                                     <td>Add new consumer as Shop as per survey Update as Approved by Senior Director and Director (MUCT) bearing Inword # XXXXX Dated XX-XX-XXXX as per KMC pick-Up Form Attached
</td>
                                <td class="fs15 fw700 text-right">
