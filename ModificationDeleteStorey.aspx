<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="ModificationDeleteStorey.aspx.cs" Inherits="ModificationDeleteStorey" %>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" runat="server" novalidate>
                      ...
                      <div class="form-group">
                       <asp:Label ID="lblmodificationstatus" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Inword Date" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         <asp:TextBox ID="txtinworddate" runat="server" type="date" class="form-control" data-validate-length-range="6" data-validate-words="2" name="name" required="required" placeholder="Modification Status"></asp:TextBox>
                        </div>
                      </div>
                       ...
                       <asp:Label ID="lblConsumerNo" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Consumer No" Font-Bold="True"></asp:Label>
                        ...
                        <div class="form-group">
                       <asp:Label ID="Label1" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="New Storey" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         <asp:TextBox ID="txtNewStorey" runat="server" type="number" class="form-control" data-validate-length-range="6" data-validate-words="2" name="name" required="required" placeholder="New Current"></asp:TextBox>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          ...
                          <asp:Button ID="btnReset" runat="server" type="reset" class="btn btn-primary" OnClick="btnReset_Click" Text="Reset" />
                      ...
                      <div class="dashboard-widget-content">
                        <div class="col-md-12 hidden-small">
                          ...
                          <table class="countries_list">
                            <tbody>
                                 <label id="lbloldarea" runat="server" visible="false"></label>
                                <label id="lblsqy_sqft" runat="server" visible="false"></label>
                                <label id="lbloldcategory" runat="server" visible="false"></label>
                                <label id="lbloldouttanding" runat="server" visible="false"></label>
                                 <label id="lbloldkmccategory" runat="server" visible="false"></label>
                                <label id="lblstorey" runat="server" visible="false"></label>
