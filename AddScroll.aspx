<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="AddScroll.aspx.cs" Inherits="AddScroll" %>
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                       <asp:Label runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Bank" Font-Bold="True"></asp:Label>
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <input runat="server"  id="Text1" class="form-control" required="required" placeholder="HABIB BANK" disabled="disabled"/>
                        </div>
                      </div>
