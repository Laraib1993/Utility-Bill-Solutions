<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="ModificationChangeOfCategory_DecreaseOfSize.aspx.cs" Inherits="ModificationChangeOfCategory_DecreaseOfSize" %>
    ...
    <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Change Of Category & Change Of Size</h3>
              </div>
                        ...
                        <div class="col-md-12 hidden-small">
                          ...
                          <table class="countries_list">
                            <tbody>
                                ...
                                <%--<tr><td><b>Old KMC Category :</b><label id="lbloldkmccategory" runat="server" visible="false"></label></td></tr>--%>
