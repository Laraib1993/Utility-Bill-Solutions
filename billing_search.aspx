<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="billing_search.aspx.cs" Inherits="billing_search" %>




<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   <title>Bill History Search</title>
</asp:Content>
     ...
     <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Search <small>Bill History</small></h2>
...
<Columns>
    ...
    <asp:BoundField 
        ...
        <asp:BoundField 
            DataField="category"
            HeaderText="CATEGORY" HeaderStyle-Wrap="False">
            <HeaderStyle HorizontalAlign="Center"></HeaderStyle> 
    ...
    <asp:BoundField 
            DataField="bill_type"
            HeaderText="Type of bill" HeaderStyle-Wrap="False">
            <HeaderStyle HorizontalAlign="Center"></HeaderStyle> 
            <ItemStyle HorizontalAlign="left" ForeColor="Black" BackColor="white" Font-Bold="True"></ItemStyle>
        </asp:BoundField> 
