<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="MUCTBills.aspx.cs" Inherits="MUCTBills" %>
                    ...
                    <form class="form-horizontal form-label-left" runat="server">
                      ...
                      <div class="ln_solid"></div>
                        ...
                        <asp:Panel ID="pnl" runat="server" Visible="false" >
                                <div class="form-group">
                        <asp:Label ID="Label2" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Employee" Font-Bold="True"></asp:Label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                             <asp:TextBox ID="txtmuctemployee" runat="server" type="text" class="form-control" placeholder="MUCT Employee"></asp:TextBox>
