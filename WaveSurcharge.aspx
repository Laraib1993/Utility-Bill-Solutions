<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="WaveSurcharge.aspx.cs" Inherits="WaveSurcharge" %>
                    ...
                    <form class="form-horizontal form-label-left" novalidate runat="server" >
                       ...
                       <asp:Label ID="lblConsumerNo" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Consumer Number" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         ...
                         <asp:TextBox ID="txtConsumerNo" runat="server" type="text" class="form-control" MaxLength="11" data-validate-length-range="6" data-validate-words="2"  required="required" placeholder="Consumer Number" OnTextChanged="txtConsumerNo_TextChanged"></asp:TextBox>
                        </div>
                      </div>
                        <div class="form-group">
