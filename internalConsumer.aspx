<%@ Page Title="" Language="C#" MasterPageFile="~/MainDashboard.master" AutoEventWireup="true" CodeFile="internalConsumer.aspx.cs" Inherits="internalConsumer" %>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" runat="server" novalidate>
                      ...
                      <div class="form-group">
                       <asp:Label ID="lblConsumerName" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Consumer Name" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         ...
                         <asp:TextBox ID="txtConsumerName" runat="server" type="text" class="form-control" data-validate-length-range="6" data-validate-words="2" name="name" required="required" placeholder="Full Name" onkeypress="return ValidAlphabet()"></asp:TextBox>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                           <asp:TextBox ID="txtCNIC" runat="server" type="number" class="form-control" required="required" placeholder="CNIC Number"></asp:TextBox>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <asp:Label ID="lblstorey" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Storey" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                           <asp:TextBox ID="txtStorey" runat="server" type="number" class="form-control" data-validate-length-range="6" data-validate-words="2"  required="required" placeholder="1" OnTextChanged="txtStorey_TextChanged"></asp:TextBox>
                       ...
                       <asp:Label ID="lblAdjustArrears" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Adjust Arrears" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                           <asp:TextBox ID="txtAdjustArrears" runat="server" type="number" class="form-control" data-validate-length-range="6" data-validate-words="2" required="required" placeholder="314"></asp:TextBox>
                       ...
                       <asp:Label ID="lblBillQuarter" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Billing Quarter" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                           <asp:TextBox ID="txtBillingQuarter" runat="server" type="number" class="form-control" data-validate-length-range="6" data-validate-words="2"  required="required" placeholder="31" OnTextChanged="txtBillingQuarter_TextChanged" ></asp:TextBox>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="fs15 fw700 text-right">
                                 ...
                                 <tr>
                                <td>Adjust Arrears</td>
                                <td class="fs15 fw700 text-right">
                                    <asp:Label ID="lbladjust" runat="server" Text=""></asp:Label>
                      ...
                      <div class="dashboard-widget-content">
                        <div class="col-md-12 hidden-small">
                          ...
                          <table class="countries_list">
                            <tbody>
                                <tr>
                                <td>Add new consumer as Flat as per survey Update as Approved by Senior Director and Director (MUCT) bearing Inword # XXXXX Dated XX-XX-XXXX as per KMC pick-Up Form Attached</td>
                                <td class="fs15 fw700 text-right">
                                   
                                    </td>
                              </tr>
                                <tr>
                                     <td>Add new consumer as Flat as per survey and also adjust previous property arrears are equally divided (RS 1064/-) on each flats existing on this property address as Approved by Senior Director and Director (MUCT) bearing Inword # XXXXX Dated XX-XX-XXXX as per KMC pick-Up Form Attached.</td>
                                ...
                                <td class="fs15 fw700 text-right">
                                 ...
                                 <tr>
                                     <td>Add new consumer as Flat as per survey and also adjust previous property arrears are equally divided (RS xxxx/-) on each flats existing on this property address as Approved by Senior Director and Director (MUCT) bearing Inword # XXXXX Dated XX-XX-XXXX as per KMC pick-Up Form Attached.</td>
