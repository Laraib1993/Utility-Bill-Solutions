...
public partial class MUCTBills : System.Web.UI.Page
{
    ...
    protected void btnFindcon_Click(object sender, EventArgs e)
    {
        ...
        //{
            ...
            cmd.CommandText = "select * from invoice where status !=6 and status !=7 and consumer_No = '" + txtConsumer.Text + "'";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand("sp_insertmuctbills", conn);
        ...
        cmd.Parameters.Add("@Employee", SqlDbType.VarChar).Value = txtmuctemployee.Text;
        cmd.Parameters.Add("@Createdby", SqlDbType.VarChar).Value = Session["UserID"];

        conn.Open();
        cmd.ExecuteNonQuery();
        conn.Close();
        txtmuctemployee.Text = "";
        txtConsumer.Text = "";
