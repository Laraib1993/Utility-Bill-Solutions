<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="CurrentAjustConsumer.aspx.cs" Inherits="SpeacialConsumer" %>
     ...
     <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Add Consumer | With Current Amount Ajustment</h3>
              </div>
                    ...
                    <form class="form-horizontal form-label-left" runat="server" novalidate>
                      ...
                      <div class="form-group">
                       ...
                       <asp:Label ID="lblTariff" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Tariff Rate" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <asp:TextBox ID="txtTariff" runat="server" type="text" class="form-control" data-validate-length-range="6" data-validate-words="2" name="name" required="required" placeholder="240"></asp:TextBox>
                          ...
                          <table class="countries_list">
                            <tbody>
							  ...
							  <tr>
                                ...
                                <td class="fs15 fw700 text-right">
                                    <asp:Label ID="lblCurrArrears" runat="server" Text=""></asp:Label>
                                </td>
                              </tr>
                              <tr>
