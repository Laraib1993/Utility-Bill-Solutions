...
public partial class internalConsumer : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
		...
		cmd = new SqlCommand("sp_paymentHistorylayout", conn);
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Add("@consumerno", SqlDbType.VarChar).Value = txtConsumerID.Text;
