...
public partial class DeptDirectorSearch : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand("sp_insertsearchingsheet", conn);
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Add("@inword", SqlDbType.Int).Value = txtinword.Text;
