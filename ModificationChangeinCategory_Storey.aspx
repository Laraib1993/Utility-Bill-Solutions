<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="ModificationChangeinCategory_Storey.aspx.cs" Inherits="ModificationChangeinCategory_Storey" %>
    ...
    <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Change Of Category & Change Of Storey</h3>
              </div>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" runat="server" novalidate>
                       ...
                       <asp:Label ID="lblConsumerNo" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Consumer No" Font-Bold="True"></asp:Label>
                        ...
                        <div class="form-group">
                       <asp:Label ID="lblNewArea" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="New Storey" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                       ...
                       <asp:Label ID="lblImpact" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Impact" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         ...
                         <div class="form-group">
                       <asp:Label ID="lblpropertyType" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="New Property Type" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                       ...
                       <asp:Label ID="Label2" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Impact" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         <asp:DropDownList class="form-control" ID="ddlsizetype" runat="server">
                             <asp:ListItem Value="0">Select Storey Type</asp:ListItem>
                  ...
                  <div class="x_content">
                      <div class="dashboard-widget-content">
                        <div class="col-md-12 hidden-small">
                          <h2 class="line_30">Change Of Category and Size</h2>
                          ...
                          <table class="countries_list">
                            <tbody>
                                ...
                                <tr><td><b>Old Arrears Unit :</b><label id="lblsqy_sqft" runat="server"></label></td></tr>
                                 <tr><td><b>Old Storey :</b><label id="lbloldstorey" runat="server"></label></td></tr>
                                <tr><td><b>Old Category :</b><label id="lbloldcategory" runat="server"></label></td></tr>
                                <tr><td><b>Old Current :</b><label id="lbloldcurrent" runat="server"></label></td></tr>
