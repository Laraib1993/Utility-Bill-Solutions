<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="ModificationDeleteConsumer.aspx.cs" Inherits="ModificationDeleteConsumer" %>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" runat="server" novalidate>
                       ...
                       <asp:Label ID="lblmodificationstatus" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Inword Date" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         <asp:TextBox ID="txtinworddate" runat="server" type="date" class="form-control" name="name" required="required" placeholder="Modification Status"></asp:TextBox>
                        </div>
                      </div>
                       ...
                       <asp:Label ID="lblConsumerNo" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" Text="Consumer No" Font-Bold="True"></asp:Label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         <asp:TextBox ID="txtConsumerNo" runat="server" type="text" OnTextChanged="txtConsumerNo_TextChanged" AutoPostBack="true" class="form-control" data-validate-length-range="6" data-validate-words="2" name="name" required="required" placeholder="Consumer No"></asp:TextBox>
                        </div>
                      </div>
