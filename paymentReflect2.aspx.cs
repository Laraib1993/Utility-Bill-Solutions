...
public partial class paymentReflect : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                if (txtConsumerNo.Text != "" && txtInword.Text != "" && txtreflect.Text != "" && txtDescription.Text != "" && ddlper.SelectedValue != "0" && ddlModify.SelectedValue != "0" && ddlreflectiobperiod.SelectedValue != "0" && txttodate.Text != "")
                {
            ...
            {
                if (txtConsumerNo.Text != "" && txtInword.Text != "" && txtreflect.Text != "" && txtDescription.Text != "" && ddlper.SelectedValue != "0" && ddlModify.SelectedValue != "0")
                {
    ...
    {
		if (txtConsumerNo.Text != "" && txtInword.Text != "" && txtreflect.Text != ""  && ddlModify.SelectedValue != "0")
                {
        double x, y;
